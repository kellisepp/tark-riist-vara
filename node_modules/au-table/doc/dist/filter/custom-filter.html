<template><h2>Custom Filters</h2><p>You also have the option to provide a custom filter for more complex situations. A custom filter will look like this:</p><pre><code class="language-js" au-syntax>filters = [
